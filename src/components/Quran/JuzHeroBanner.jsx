...
const JuzHeroBanner = ({ juzNumber, juzSurahs }) => {
  ...
  return (
    <div className='bg-gradient-to-br from-primary to-[#312e81] rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-12 text-white text-center relative overflow-hidden mb-4 md:mb-6'>
