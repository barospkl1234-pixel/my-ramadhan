...
const SurahSeparator = ({ namaArab, namaLatin }) => (
  <div className='flex items-center gap-4 py-4 md:py-6 my-2'>
    ...
    <div className='flex items-center gap-3 bg-blue-50 dark:bg-primary-bg border border-blue-100 dark:border-blue-900 rounded-full px-5 py-2.5 md:py-3 shrink-0'>
      <span className='font-amiri text-xl md:text-2xl text-primary dark:text-primary'>
        {namaArab}
      </span>
